...
const Home = () => {
  return (
    <div>
        ...
        <img src="https://thumbs.dreamstime.com/b/science-technology-engineering-math-concept-outline-blue-banner-dark-background-vector-illustration-stem-151274081.jpg" className="my-10 rounded-lg mx-auto" alt="banner"/>
    </div>
  );
};
